...
public class WoodenBeam {
	 ...
	 * @param base
	 *            The base of the wooden beam
	 * @param height
	 *            The height of the wooden beam
	 * @param A
	 *            The stress of the wooden beam
	 * @param I
	 *            The inertia of the wooden beam
	 * @param c
	 *            The centroid of the wooden beam
	 * @param maxload
	 *            The maxload of the wooden beam
	 */
	public void PrintWoodenBeam(double length, double base, double height, double A, double I, double c,
			double maxload) {
		System.out.println("For Beam #1:");
		System.out.println(
				"The length of the beam is d = " + length + " feet which is equal to " + (length * 12) + " inches");
		...
		System.out.print("The rectangular moment of inertia is: " + I + " in^4\n");
